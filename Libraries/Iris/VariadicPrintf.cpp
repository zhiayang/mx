...
namespace StdIO
{
	...
	// strings
	template <>
	astl::string _print(astl::string str, uint16_t f, uint8_t w, uint8_t p)
	{
	...
	template <>
	astl::string _print(const char* c, uint16_t f, uint8_t w, uint8_t p)
	{
		astl::string fmt = _getfmt(f, w, p);
		fmt += "s";
	...
	template <>
	astl::string _print(char* c, uint16_t f, uint8_t w, uint8_t p)
	{
		astl::string fmt = _getfmt(f, w, p);
		fmt += "s";
	...
	template <>
	astl::string _print(unsigned char c, uint16_t f, uint8_t w, uint8_t p)
	{
		astl::string fmt = _getfmt(f, w, p);
	...
	template <>
	astl::string _print(short c, uint16_t f, uint8_t w, uint8_t p)
	{
		astl::string fmt = _getfmt(f, w, p);
	...
	template <>
	astl::string _print(unsigned short c, uint16_t f, uint8_t w, uint8_t p)
	{
		astl::string fmt = _getfmt(f, w, p);
	...
	template <>
	astl::string _print(int c, uint16_t f, uint8_t w, uint8_t p)
	{
		astl::string fmt = _getfmt(f, w, p);
	...
	template <>
	astl::string _print(unsigned int c, uint16_t f, uint8_t w, uint8_t p)
	{
		astl::string fmt = _getfmt(f, w, p);
	...
	template <>
	astl::string _print(long c, uint16_t f, uint8_t w, uint8_t p)
	{
		astl::string fmt = _getfmt(f, w, p);
	...
	template <>
	astl::string _print(unsigned long c, uint16_t f, uint8_t w, uint8_t p)
	{
		astl::string fmt = _getfmt(f, w, p);
	...
	template <>
	astl::string _print(long long c, uint16_t f, uint8_t w, uint8_t p)
	{
		astl::string fmt = _getfmt(f, w, p);
	...
	template <>
	astl::string _print(unsigned long long c, uint16_t f, uint8_t w, uint8_t p)
	{
		astl::string fmt = _getfmt(f, w, p);
	...
	template <>
	astl::string _print(float c, uint16_t f, uint8_t w, uint8_t p)
	{
		astl::string fmt = _getfmt(f, w, p);
	...
	template <>
	astl::string _print(double c, uint16_t f, uint8_t w, uint8_t p)
	{
		astl::string fmt = _getfmt(f, w, p);
	...
	template <>
	astl::string _print(long double c, uint16_t f, uint8_t w, uint8_t p)
	{
		astl::string fmt = _getfmt(f, w, p);
		fmt += astl::string("L") + _getSpecForFloat(f);
